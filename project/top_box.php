...
if (empty($item)) {
   ...
   echo $item;
   echo " performers <br>";
   echo "(values listed in millions of dollars) <br><br>";

   //Prepare a statement that we can later execute. The ?'s are placeholders for
   //parameters whose values we will set before we run the query.
   if ($stmt = $conn->prepare("CALL top_box(?)")) {
      ...
      if ($stmt->execute()) {
         ...
         if (($result) && ($result->num_rows != 0)) {
            ...
            echo "<tr><th> movie </th> <th> international box office </th><th> domestic box office </th></tr>";
